                    ...
                    <div className="w-full h-[4rem] ">
                        {loggedInUser ? (
                            <section className="flex justify-between items-center px-2">
                                ...
                                <div className="relative py-2 group flex justify-between gap-5">
                                    <div>
                                        <Avatar img={avathar} alt="avatar" rounded />
                                    </div>
                                    <button className="bg-red-500 px-2  rounded-lg" onClick={handleLogout}><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
